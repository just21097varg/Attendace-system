...
def function5():    
  os.startfile("https://file:/C:/Users/JUSTIN/attendance/developers/diet1frame1first.html")
...
def attend():
    os.startfile("C:/Users/JUSTIN/attendance/firebase/attendance_files/attendance.xls")

#stting title for the window
root.title("AUTOMATIC ATTENDANCE MANAGEMENT USING FACE RECOGNITION")

#creating a text label
Label(root, text="FACE RECOGNITION ATTENDANCE SYSTEM",font=("times new roman",20),fg="white",bg="maroon",height=2).grid(row=0,rowspan=2,columnspan=2,sticky=N+E+W+S,padx=20,pady=20)
